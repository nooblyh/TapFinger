...
# synthetic
job_min_requirement = {JobType.IMG: np.asarray([3, 3], dtype=int),
                       JobType.LM: np.asarray([3, 3], dtype=int),}
...
resource_progress_base = {JobType.IMG: np.asarray([1]),
                          JobType.LM: np.asarray([0.1])}
progress_noise = 0
